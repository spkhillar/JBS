...
<spring:url value="/resources/css/menubar.css"	var="resourceMenuBarCSSUrl" />
<spring:url value="/resources/js/menu.js" var="resourceMenuJsUrl" />

<link rel="stylesheet" type="text/css" href="${resourceMenuBarCSSUrl}" />
<script type="text/javascript" src="${resourceMenuJsUrl}"></script>
...
<body>
	...
	<table border="0" id="indextb">
		<tr>
			<th scope="col"><a href="http://www.jobsbysms.com"
			...
			<td scope="col" colspan="2" class="siteheadercells">
				<form action="${contextPath}/j_spring_security_check" method="post">
					...
					<label style="font-size: 12px; color: blue; font-style: normal;">
						<br>
					<a href="${contextPath}/manage/forgotpassword" style="float: left">Forgot
							Password</a>
					</label>
		...
		<tr>
			<td height="27" colspan="4" class="menutd">
							<ul id="menu">
										...
										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/1">Central
												Govt Jobs</a></li>

										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/2">State Govt
												Jobs</a></li>

										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/3">Private
												Jobs</a></li>

										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/4">IT Jobs</a></li>

										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/5">Banking and
												Finance Jobs</a></li>
										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/6">Railway
												Jobs</a></li>
										<li><a class="fNiv"
											href="${contextPath}/admin/job/site/detail/8">Marketing
												Jobs</a></li>
